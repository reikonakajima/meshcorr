...
//	The complex arrays (kTables) need not be Hermitian.
//      -> the xTables are complex
...
//	k-space arrays have origin at [0,0]
//         <??? Note this means negative frequencies are at end ???>
...
// Class holding k-space representation of complex function.
